...
const data = reactive(
    {
        ...
        data: [
            { id: 1, username: "admin", path: "/login", title: "登录", createTime: "2021-01-01 00:00:00", ip: "223.73.30.234", ipFrom: "中国 广东省 东莞市", userTIme: 73, browser: "Chrome" },
            { id: 2, username: "admin", path: "/logout", title: "登出", createTime: "2021-01-01 00:00:00", ip: "223.73.30.234", ipFrom: "中国 广东省 东莞市", userTIme: 450, browser: "Chrome" },
            { id: 3, username: "admin", path: "/login", title: "登录", createTime: "2021-01-01 00:00:00", ip: "223.73.30.234", ipFrom: "中国广东省东莞市", userTIme: 1530, browser: "Chrome" },
            { id: 4, username: "admin", path: "/logout", title: "登出", createTime: "2021-01-01 00:00:00", ip: "223.73.30.234", ipFrom: "中国广东省东莞市", userTIme: 720, browser: "Chrome" },
        ]
    }
)
